...
$$
\log(x_i) \sim N(\mu, \sigma)\quad\text{for $i \in 1, 2 \ldots n$}
$$
...
* We calculate the likelhood function
  $$
...
* By making this addtion, we are assuming an expaneded probabilitic generative model:
$$
\begin{aligned}
...
* The probability distribution $h_0(\Omega_0$ is known as the *prior*,
